  ...
  return (
    <div className="fixed inset-0 z-40 min-h-full overflow-y-auto md:w-[80%] ml-auto overflow-x-hidden transition flex items-center">
      ...
      <div className="relative w-full cursor-pointer pointer-events-none transition my-auto p-4">
        <div className="bg-[#1c1c22] w-full py-2 cursor-default pointer-events-auto relative rounded-xl mx-auto max-w-sm">
            ...
            <div className="px-6 py-2">
              <div className="grid gap-2 grid-cols-[repeat(auto-fit,minmax(0,1fr))]">
                ...
                <button
                  type="submit"
                  onClick={add}
                  className="inline-flex items-center justify-center py-1 gap-1 font-medium rounded-lg border transition-colors outline-none min-h-[2.25rem] px-4 text-sm  shadow 
