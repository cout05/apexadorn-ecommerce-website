...
const Header = () => {
  return (
    <div className="bg-[#eff6e0] md:fixed md:w-[20%] h-10 md:h-screen border">
      <div className="bg-[#1c1c22] flex relative items-center justify-between text-[#eff6e0] px-2  md:p-0 md:ml-4 md:mr-5 md:text-center md:rounded-md md:my-4 h-[50px] md:h-[150px]">
